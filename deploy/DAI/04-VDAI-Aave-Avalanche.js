...
const VDAI = require('../../helper/avalanche/poolConfig').VDAI
const Address = require('../../helper/avalanche/address')

const PoolAccountant = 'PoolAccountant'
const strategyName = 'AaveStrategAvalancheDAI'
...
module.exports.tags = ['VDAI-AVAX-v3.0.8']
