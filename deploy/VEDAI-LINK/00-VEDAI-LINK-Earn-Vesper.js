...
const VEDAI = require('../../helper/mainnet/poolConfig').VEDAI_LINK
const Address = require('../../helper/mainnet/address')
const PoolAccountant = 'PoolAccountant'
const EarnStrategy = 'EarnVesperStrategyDAILINK'
...
const deployFunction = async function ({ getNamedAccounts, deployments }) {
  ...
  const rewardsProxy = await deploy('VesperEarnDrip', {
    ...
    proxy: {
      ...
      execute: {
        init: {
          methodName: 'initialize',
          args: [poolProxy.address, [Address.vLINK, Address.VSP]],
        },
      },
    },
  })
  ...
  await execute('VesperEarnDrip', { from: deployer, log: true }, 'updateGrowToken', Address.vLINK)
  ...
  deployFunction.id = 'veDAI-LINK-vaDAI-1'
  return true
}
module.exports = deployFunction
module.exports.tags = ['veDAI-LINK-vaDAI-1']
