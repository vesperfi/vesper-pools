...
const VELINK = require('../../helper/mainnet/poolConfig').VELINK_DAI
const Address = require('../../helper/mainnet/address')
const PoolAccountant = 'PoolAccountant'
const EarnStrategy = 'EarnVesperMakerStrategyLINK'
...
const deployFunction = async function ({ getNamedAccounts, deployments }) {
  ...
  const poolProxy = await deploy(VELINK.contractName, {
    from: deployer,
    log: true,
    args: VELINK.poolParams, // Constructor args
    // proxy deployment
    proxy: {
      proxyContract: 'OpenZeppelinTransparentProxy',
      ...
      execute: {
        init: {
          ...
          args: [...VELINK.poolParams, accountantProxy.address, Address.ADDRESS_LIST_FACTORY],
        },
      },
    },
  })
  ...
  await execute(VELINK.contractName, { from: deployer, log: true }, 'updatePoolRewards', rewardsProxy.address)
  ...
  deployFunction.id = 'veLINK-DAI-vaDAI-1'
  return true
}
module.exports = deployFunction
module.exports.tags = ['veLINK-DAI-vaDAI-1']
