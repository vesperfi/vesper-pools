...
const VEDAI = require('../../helper/mainnet/poolConfig').VEDAI_WBTC
const Address = require('../../helper/mainnet/address')
const PoolAccountant = 'PoolAccountant'
const EarnStrategy = 'EarnVesperStrategyDAIWBTC'
...
const deployFunction = async function ({ getNamedAccounts, deployments }) {
  ...
  const rewardsProxy = await deploy('VesperEarnDrip', {
    ...
    proxy: {
      ...
      execute: {
        init: {
          methodName: 'initialize',
          args: [poolProxy.address, [Address.vaWBTC, Address.VSP]],
        },
      },
    },
  })
  ...
  await execute('VesperEarnDrip', { from: deployer, log: true }, 'updateGrowToken', Address.vaWBTC)
  ...
  deployFunction.id = 'veDAI-WBTC-vaDAI-1'
  return true
}
module.exports = deployFunction
module.exports.tags = ['veDAI-WBTC-vaDAI-1']
