...
contract ConvexCoverageStrategyDAI is ConvexCoverageStrategy {
    string public constant NAME = "Curve-Convex-3pool-DAI-Coverage-Strategy";
    ...
    constructor(address _pool, address _swapManager)
        ConvexCoverageStrategy(_pool, THREEPOOL, THREECRV, GAUGE, _swapManager, 0, 9)
    {}
}
