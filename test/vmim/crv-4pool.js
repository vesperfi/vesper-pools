...
describe('vMIM Pool with Crv4PoolStrategy', function () {
  ...
  describe('Strategy Tests', function () {
    after(reset)
    shouldBehaveLikeStrategy(0, StrategyType.CURVE, 'Crv4PoolStrategyMIMPoolMIM')
  })

  describe('Crv4PoolStrategy: MIM Functionality', function () {
    afterEach(reset)
