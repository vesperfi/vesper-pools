...
describe('vMIM Pool with Crv2PoolStrategy', function () {
  ...
  beforeEach(async function () {
    ...
    await setupVPool(this, {
      ...
      strategies: [
        {
          name: 'Crv2PoolStrategyMIMUSTPoolMIM',
  ...
  describe('Strategy Tests', function () {
    after(reset)
    shouldBehaveLikeStrategy(0, StrategyType.CURVE, 'Crv2PoolStrategyMIMUSTPoolMIM')
  })

  describe('Crv2PoolStrategy: MIM Functionality', function () {
    afterEach(reset)
