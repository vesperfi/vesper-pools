...
describe('vUSDC Pool with Crv4MetaPoolStrategy', function () {
  const strategy1 = strategyConfig.Convex4MetaPoolStrategyFRAXPoolUSDC
  ...
  describe('Crv4MetaPoolStrategy: USDC Functionality', function () {
