...
function prepareConfig(_strategies) {
  ...
  if (!strategies) {
    const strategy1 = strategyConfig.AaveStrategyAvalancheAVAX
    const strategy2 = strategyConfig.AaveStrategyAvalancheAVAX
    strategy1.config.debtRatio = 6000
